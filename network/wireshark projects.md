...
## 🎯 Objective
Analyze network traffic using Wireshark to understand how a client resolves a domain (DNS) and communicates with a web server (HTTP).

---

## 🔍 Scenario
A client accessed the following website:
...
- Identified record type:
  A (IPv4)
- Extracted IP address from response:
  104.18.x.x
...
- The client first resolved example.com using DNS  
...
- Traffic correlation is essential in SOC and network analysis  
